...
class LinkedList:
    ...
    def reverse_list(self):
        current_node = self.head  # current node initialized as head
        previous = None
        while current_node:
            temp = current_node.next_node  # create temp referencing next node
            # reverse direction
            ...
            # print("previous value", previous.value)
            # set current to temp
            current_node = temp
        # update head to previous (last node) after done looping
        self.head = previous
